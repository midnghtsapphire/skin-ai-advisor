  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground font-semibold shadow-glow hover:shadow-[0_0_50px_-10px_hsl(350_70%_65%_/_0.5)] hover:scale-[1.02] active:scale-[0.98]",
        gold: "gradient-gold text-accent-foreground font-semibold shadow-soft hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        glass: "glass-card border border-primary/20 text-foreground hover:border-primary/40 hover:shadow-soft",
      },
      size: {
